...
@section('content')
    <div class="tp-contact-4__area pt-120 pb-120">
        <div class="container">
            <div class="tp-contact-4__top pb-40">
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div
                            class="tp-contact-4__item d-flex align-items-center justify-content-start justify-content-sm-center">
                            ...
                            <div class="tp-contact-4__text">
                                ...
                                <br>
                                <a href="mailto:jpn.contact@shwewutthmonekha.com">
                                    jpn.contact@shwewutthmonekha.com
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div
                            class="tp-contact-4__item d-flex align-items-center align-items-center justify-content-start justify-content-sm-center">
                            <div class="tp-contact-4__icon">
                                <span>
                                    <svg width="46" height="65" viewBox="0 0 46 65" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="tp-contact-4__text">
                                ...
                                <a href="https://maps.app.goo.gl/JA5K6BtgW3Lc6bdL7">
                                    No.95, A1 Ground Floor, <br> Bandoola Road, Yangon 11421
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tp-contact-4__contact-form">
                            ...
                            <div class="row">
                                <form id="create-form" class="cons-contact-form" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3 tp-contact-4__input-box">
